...
namespace GUIObjectsLib
{
    public class ExtendedComboBox : ComboBox
    {
        ...
        private class ACWindow : NativeWindow
        {
            ...
            private static readonly List<ExtendedComboBox> owners;
            ...
            private ExtendedComboBox owner;

            static ACWindow()
            {
                ACWindows = new Dictionary<IntPtr, ACWindow>();

                owners = new List<ExtendedComboBox>();
            }
            ...
            /// </summary>  
            public static void RegisterOwner(ExtendedComboBox owner)
            {
            ...
            protected override void WndProc(ref Message m)
            {
                if ((m.Msg == WM_WINDOWPOSCHANGED))
                {
                    ...
                    if ((owner == null))
                    {
                        ...
                        foreach (ExtendedComboBox cbo in owners)
                        {
